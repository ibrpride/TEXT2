$modeCommand = 'mode con: cols=65 lines=33'
Invoke-Expression -Command $modeCommand

<#
.NOTES
    Author         : IBRPRIDE
    Runspace Author: @IBRPRIDE
...
Start-Transcript -Path "$ENV:TEMP\Winutil.log" -Append -NoClobber *> $null
...
function Invoke-WPFButton {
    ...
    #[System.Windows.MessageBox]::Show("$Button","IBRPRIDE","OK","Info")
...
Write-Host ""
Write-Host ""
Write-Host "               ___  _   _   _   _  ___  _   _    _  _        " -ForegroundColor Red
Write-Host "                |  |_) |_) |_) |_)  |  | \ |_   /  / \ |\/|  " -ForegroundColor Red 
Write-Host "               _|_ |_) | \ |   | \ _|_ |_/ |_ o \_ \_/ |  |  " -ForegroundColor Red
Write-Host "                                                             " -ForegroundColor Red
Write-Host ""
Write-Host "                  :!JPB#&&&&&&#BPJ!:                "
Write-Host "               ^JB&&B5J7!~~~~!7J5B&&BY~.           ."
Write-Host "            .?B@#Y~.              .~JB&5^  .^~7J5PJ^"
Write-Host "           7#@G~                     ^7J5PB&@@@@G!  "
Write-Host "         .P@#~                 .~7YG#&@@@@@@@@P~    "
Write-Host "        G@P            .~JG&@@@@@@@@@#G5J7~:        "
Write-Host "       ?@&:          ~Y#@@@@@@@@&GY!^:.             "
Write-Host "       B@5        .?B@@@@@@@&GJ!~~7YGP^             "
Write-Host "       &@J      .J#@@@@@@@GJ7?5B&@@@Y.              "
Write-Host "       B@5     !#@@@@@@&B5PB@@@@@@G^                "
Write-Host "       J@#.   Y@@@@@@@@&&@@@@&BPJ!                  "
Write-Host "       .B@5  P@@@@@@@@@@@#P?!^^                     "
Write-Host "         : :&@@@@@@@@#GB&@@@#^                      "
Write-Host "           7@@@@@@@@@@@@&##G:                       "
...
function Invoke-WPFShortcut {
    ...
    Switch ($ShortcutToAdd) {
        "WinUtil" {
            ...
            $IRM = 'irm https://IBRPRIDE.COM | iex'
            $Powershell = '-ExecutionPolicy Bypass -Command "Start-Process powershell.exe -verb runas -ArgumentList'
            $ArgumentsToSourceExe = "$powershell '$IRM'"
            $DestinationName = "IBRPRIDE.lnk"
        }
    }
...
function Invoke-WPFtweaksbutton {
  ...
  Invoke-WPFRunspace -ArgumentList $Tweaks -ScriptBlock {
	...
	Write-Host "---       IBRPRIDE.COM        ---"
    Write-Host "================================="

    $ButtonType = [System.Windows.MessageBoxButton]::OK
    $MessageboxTitle = "Tweaks are Finished - IBRPRIDE"
    $Messageboxbody = ("Done")
    $MessageIcon = [System.Windows.MessageBoxImage]::Information
...
$inputXML = '<Window x:Class="WinUtility.MainWindow"
        ...
        Title="IBRPRIDE" Height="800" Width="1200">
    <Window.Resources>
    ...
    <Border Name="WPFdummy" Grid.Column="0" Grid.Row="0">
        <Viewbox Stretch="Uniform" VerticalAlignment="Top">
            <Grid Background="#ffffff" ShowGridLines="False" Name="WPFMainGrid">
                <Grid.RowDefinitions>
                ...
                <DockPanel Background="#ffffff" SnapsToDevicePixels="True" Grid.Row="0" Width="1100">
                    <Image Height="50" Width="100" Name="WPFIcon" SnapsToDevicePixels="True" Source="https://media.discordapp.net/attachments/1081377680664039555/1109141833348554922/avatar2.png" Margin="0,10,0,10"/>
                    <Button Content="Install" HorizontalAlignment="Left" Height="40" Width="100" Background="#C50000" BorderThickness="0,0,0,0" FontWeight="Bold" Foreground="#ffffff" Name="WPFTab1BT"/>
                    <Button Content="Tweaks" HorizontalAlignment="Left" Height="40" Width="100" Background="#E30000" BorderThickness="0,0,0,0" FontWeight="Bold" Foreground="#ffffff" Name="WPFTab2BT"/>
                    <Button Content="Config" HorizontalAlignment="Left" Height="40" Width="100" Background="#FF0B0B" BorderThickness="0,0,0,0" FontWeight="Bold" Foreground="#ffffff" Name="WPFTab3BT"/>
                    <Button Content="Updates" HorizontalAlignment="Left" Height="40" Width="100" Background="#FF2F2F" BorderThickness="0,0,0,0" FontWeight="Bold" Foreground="#ffffff" Name="WPFTab4BT"/>
                </DockPanel>
                <TabControl Grid.Row="1" Padding="-1" Name="WPFTabNav" Background="#800000">
                    <TabItem Header="Install" Visibility="Collapsed" Name="WPFTab1">
                        <Grid Background="#ffffff">
                            ...
                            <StackPanel Background="#ffffff" Orientation="Horizontal" Grid.Row="0" HorizontalAlignment="Center" Grid.Column="0" Grid.ColumnSpan="3" Margin="10">
                            ...
                            <StackPanel Background="#ffffff" Orientation="Horizontal" Grid.Row="0" HorizontalAlignment="Center" Grid.Column="3" Grid.ColumnSpan="2" Margin="10">
                            ...
                            <StackPanel Background="#ffffff" SnapsToDevicePixels="True" Grid.Row="1" Grid.Column="0" Margin="10">
                            ...
                            <StackPanel Background="#ffffff" SnapsToDevicePixels="True" Grid.Row="1" Grid.Column="1" Margin="10">
                            ...
                            <StackPanel Background="#ffffff" SnapsToDevicePixels="True" Grid.Row="1" Grid.Column="2" Margin="10">
                            ...
                            <StackPanel Background="#ffffff" SnapsToDevicePixels="True" Grid.Row="1" Grid.Column="3" Margin="10">
                            ...
                            <StackPanel Background="#ffffff" SnapsToDevicePixels="True" Grid.Row="1" Grid.Column="4" Margin="10">
                    ...
                    <TabItem Header="Tweaks" Visibility="Collapsed" Name="WPFTab2">
                        <Grid Background="#000000">
                            ...
                            <StackPanel Background="#ffffff" Orientation="Horizontal" Grid.Row="0" HorizontalAlignment="Center" Grid.Column="0" Margin="10">
                            ...
                            <StackPanel Background="#ffffff" Orientation="Horizontal" Grid.Row="0" HorizontalAlignment="Center" Grid.Column="1" Margin="10">
                                <Label Content="Configuration File:" FontSize="17" VerticalAlignment="Center"/>
                                <Button Name="WPFimport" Content=" Import " Margin="7"/>
                                <Button Name="WPFexport" Content=" Export " Margin="7"/>
                            </StackPanel>
                            <StackPanel Background="#000000" Orientation="Horizontal" Grid.Row="2" HorizontalAlignment="Center" Grid.ColumnSpan="2" Margin="10">
                                <TextBlock Padding="10">
                                    Note: Hover over items to get a better description. Please be careful as many of these tweaks will heavily modify your system.
                                    <LineBreak/>Recommended selections are for normal users and if you are unsure do NOT check anything else!
                                </TextBlock>
                            </StackPanel>
                            <StackPanel Background="#ffffff" SnapsToDevicePixels="True" Grid.Row="1" Grid.Column="0" Margin="10,5">
                            ...
                            <StackPanel Background="#ffffff" SnapsToDevicePixels="True" Grid.Row="1" Grid.Column="1" Margin="10,5">
                    ...
                    <TabItem Header="Config" Visibility="Collapsed" Name="WPFTab3">
                        <Grid Background="#020512">
                            <Grid.ColumnDefinitions>
                                <ColumnDefinition Width="*"/>
                                <ColumnDefinition Width="*"/>
                            </Grid.ColumnDefinitions>
                            <StackPanel Background="#ffffff" SnapsToDevicePixels="True" Grid.Column="0" Margin="10,5">
                            ...
                            <StackPanel Background="#ffffff" SnapsToDevicePixels="True" Grid.Column="1" Margin="10,5">
                    ...
                    <TabItem Header="Updates" Visibility="Collapsed" Name="WPFTab4">
                        <Grid Background="#060a25">
                            ...
                            <StackPanel Background="#ffffff" SnapsToDevicePixels="True" Grid.Column="2" Margin="10,5">
