        ...
        <Viewbox Stretch="Uniform" VerticalAlignment="Top">
            <Grid Background="#ffffff" ShowGridLines="False" Name="MainGrid">
                ...
                <DockPanel Background="#ffffff" SnapsToDevicePixels="True" Grid.Row="0" Width="1100">
                    <Image Height="50" Width="100" Name="Icon" SnapsToDevicePixels="True" Source="https://cdn.discordapp.com/attachments/1081377680664039555/1086226563835625482/ibrpride.png" Margin="0,10,0,10"/>
                    <Button Content="Install" HorizontalAlignment="Left" Height="40" Width="100" Background="#000000" BorderThickness="0,0,0,0" FontWeight="Bold" Foreground="#ffffff" Name="Tab1BT"/>
                    <Button Content="Tweaks" HorizontalAlignment="Left" Height="40" Width="100" Background="#000000" BorderThickness="0,0,0,0" FontWeight="Bold" Foreground="#ffffff" Name="Tab2BT"/>
                    <Button Content="Config" HorizontalAlignment="Left" Height="40" Width="100" Background="#000000" BorderThickness="0,0,0,0" FontWeight="Bold" Foreground="#ffffff" Name="Tab3BT"/>
                    <Button Content="Updates" HorizontalAlignment="Left" Height="40" Width="100" Background="#000000" BorderThickness="0,0,0,0" FontWeight="Bold" Foreground="#ffffff" Name="Tab4BT"/>
                </DockPanel>
                <TabControl Grid.Row="1" Padding="-1" Name="TabNav" Background="#800000">
                    <TabItem Header="Install" Visibility="Collapsed" Name="Tab1">
                        <Grid Background="#ffffff">
                            ...
                            <StackPanel Background="#ffffff" SnapsToDevicePixels="True" Grid.Column="0" Margin="10">
                            ...
                            <StackPanel Background="#ffffff" SnapsToDevicePixels="True" Grid.Column="1" Margin="10">
                            ...
                            <StackPanel Background="#ffffff" SnapsToDevicePixels="True" Grid.Column="2" Margin="10">
                            ...
                            <StackPanel Background="#ffffff" SnapsToDevicePixels="True" Grid.Column="3" Margin="10">
                            ...
                            <StackPanel Background="#ffffff" SnapsToDevicePixels="True" Grid.Column="4" Margin="10">
                    ...
                    <TabItem Header="Tweaks" Visibility="Collapsed" Name="Tab2">
                        <Grid Background="#000000">
                            ...
                            <StackPanel Background="#ffffff" Orientation="Horizontal" Grid.Row="2" HorizontalAlignment="Center" Grid.ColumnSpan="2" Margin="10">
                                <TextBlock Padding="10">
                                    Note: Hover over items to get a better description. Please be careful as many of these tweaks will heavily modify your system.
                                    <LineBreak/>                                       www.ibrpride.com!
                                </TextBlock>
                            </StackPanel>
